...
\hangpara
{\bf Accepted.}\hspace{1ex}Moran, Steven, Eitan Grossman and Annemarie Verkerk. Investigating diachronic trends in phonological inventories using BDPROTO. \textit{Language Resource and Evaluation}.
...
\vskip 6pt
\hangpara
{\bf 2019}\hspace{1ex}\textit{Scientific committee}: Language, Data, and Knowledge (LDK 2019). \textit{Journal reviewer}: Lingua; Open Handbook of Linguistic Data Management; Linguistics Vanguard. \textit{Grant reviewer}: Endangered Language Documentation Programme (ELDP). \textit{Program committee}: Association Linguistic Typology (ALT 2019); Language, Data and Knowledge (LDK 2019).
