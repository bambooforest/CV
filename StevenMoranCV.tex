...
\hangpara
{\bf Accepted}\hspace{1ex}Chodroff, Eleanor, Blaž Pažon, Annie Baker and Steven Moran. Phonetic Segmentation of the UCLA Phonetics Lab Archive. The 2024 Joint International Conference on Compuational Linguistics and Language Resources and Evaluation (LREC-COLING 2024). % May 20-25, Torino, Italy.

\vskip 6pt
\hangpara
{\bf Accepted}\hspace{1ex}Forkel, Robert, Daniel Swanson and Steven Moran. Converting legacy data to CLDF: A FAIR exit strategy for linguistic web apps. The 2024 Joint International Conference on Compuational Linguistics and Language Resources and Evaluation (LREC-COLING 2024).

\vskip 6pt
\hangpara
{\bf Accepted}\hspace{1ex}Everett, Caleb, Steven Moran and Axel G. Ekstr{\"o}m. The phoneme as cognitive technology. EVOLANG XV (2024).

\vskip 6pt
\hangpara
{\bf Accepted}\hspace{1ex}Ekstr{\"o}m, Axel G., Steven Moran. What phonetics has to say about Neanderthal (\textit{H. Neanderthalensis}) speech capacities. EVOLANG XV (2024).
...
\hangpara
Samardzic, Tanja, Ximena Gutierrez, Christian Bentz, Steven Moran and Olga Pelloni. A Measure for Transparent Comparison of Linguistic Diversity in Multilingual NLP Data Sets. \url{https://arxiv.org/abs/2403.03909}.
