...
\hangpara
{\bf Accepted.}\hspace{1ex}Moran, Steven$^*$, Dami{\'a}n E. Blasi$^*$, Scott R. Moisik, Paul Widmer, Dan Dediu and Balthasar Bickel. Human sound systems are shaped by post-Neolithic changes in bite configuration. \textit{Science}. $^*$Shared first authorship.
...
\vskip 6pt
\hangpara
{\bf 2011}\hspace{1ex}Moran, Steven. An Ontology for Accessing Transcription Systems. In {\it Language Resources \& Evaluation: Special Issue on African Language Technology}, Guy De Pauw, Laurette Pretorius, Gilles-Maurice de Schryver and Lori Levin (eds). Online: \url{https://link.springer.com/article/10.1007/s10579-011-9158-8}.% 345--360 - Volume 45, Issue 3 Heidelberg
...
\vskip 6pt
\hangpara
{\bf 2018}\hspace{1ex}Moran, Steven and Annemarie Verkerk. Differential rates of change in consonant and vowel systems. In C. Cuskley and M. Flaherty and H. Little and Luke McCrohon and A. Ravignani and T. Verhoef (eds.), The Evolution of Language: Proceedings of the 12th International Conference (EVOLANGXII). April 16--19, Toru{\'n}, Poland. Online \url{http://evolang.org/torun/proceedings/papertemplate.html?p=98}. % DOI={10.12775/3991-1.077}
...
\vskip 6pt
\hangpara
{\bf 2019}\hspace{1ex}\textit{Workshop organizer}: `Phonological (in)stability' to be hosted at the 52nd Annual Meeting of the Societas Linguistica Europaea (SLE), with Eitan Grossman. Workshop `Current research in phonological typology' to be hosted at the 13th meeting of the Association for Linguistic Typology (ALT), with Eitan Grossman. \textit{Scientific committee}: Language, Data, and Knowledge (LDK 2019). \textit{Journal reviewer}: Lingua. \textit{Grant reviewer}: Endangered Language Documentation Programme (ELDP). 
