...
\vskip 6pt
\hangpara
{\bf 2018}\hspace{1ex}Forkel, Robert and Steven Moran. cldf/segments: Unicode Standard tokenization (Version v2.0.0). Zenodo. DOI: \url{http://doi.org/10.5281/zenodo.1283757}.

\vskip 6pt
\hangpara
{\bf 2017}\hspace{1ex}Moran, Steven and Robert Forkel. cldf/segments: segments 1.1.1 (Version v1.1.1). Zenodo. DOI: \url{http://doi.org/10.5281/zenodo.1051158}.
...
\vskip 6pt
\hangpara
{\bf 2019}\hspace{1ex}\textit{Scientific committee}: Language, Data, and Knowledge (LDK 2019). \textit{Reviewer}: Lingua; Open Handbook of Linguistic Data Management; Linguistics Vanguard. \textit{Grant reviewer}: Endangered Language Documentation Programme (ELDP). \textit{Program committee}: Association Linguistic Typology (ALT 2019); Language, Data and Knowledge (LDK 2019).
