...
% \hangpara
% {\bf Submitted.}\hspace{1ex}Blasi, Dami{\'a}n, Steven Moran, Paul Widmer, Scott R. Moisik, Ani Margvelashvili, Dan Dediu and Balthasar Bickel. Human sound systems are shaped by post-Neolithic changes in dentition.
...
\vskip 6pt
\hangpara
{\bf 2012}\hspace{1ex}Cysouw, Michael, Dan Dediu and Steven Moran. Still No Evidence for an Ancient Language Expansion from Africa. \textit{Science}, 335(6069):657. \url{http://www.sciencemag.org/content/335/6069/657.2.full}
...
\hangpara
{\bf Accepted.}\hspace{1ex}Moran, Steven and Michael Cysouw. {\it The Unicode Cookbook for Linguists: Managing writing systems using orthography profiles}. Translation and Multilingual Natural Language Processing series in Language Science Press. \url{https://github.com/unicode-cookbook}
...
\vskip 6pt
\hangpara
{\bf 2011}\hspace{1ex}Moran, Steven. An Ontology for Accessing Transcription Systems. In {\it Language Resources \& Evaluation: Special Issue on African Language Technology}, Guy De Pauw, Laurette Pretorius, Gilles-Maurice de Schryver and Lori Levin (eds). % 345--360 - Volume 45, Issue 3 Heidelberg
...
\vskip 6pt
\hangpara
{\bf 2018}\hspace{1ex}Steven Moran and Annemarie Verkerk. Differential rates of change in consonant and vowel systems. In C. Cuskley and M. Flaherty and H. Little and Luke McCrohon and A. Ravignani and T. Verhoef (Eds.), The Evolution of Language: Proceedings of the 12th International Conference (EVOLANGXII). April 16--19, Toru{\'n}, Poland. Online \url{http://evolang.org/torun/proceedings/papertemplate.html?p=98}. % DOI={10.12775/3991-1.077}
...
\vskip 6pt
\hangpara
{\bf 2008}\hspace{1ex}Fox, Naomi and Steven Moran. From the Field to the World. In {\it Proceedings from the 20th Northwest Linguistics Conference (NWLC)}, Steven Moran, Darren S. Tanner and Michael Scanlon (eds). Seattle, Washington. % 109--114

\vskip 6pt
\hangpara
{\bf 2006}\hspace{1ex}Boynton, Jessica, Steven Moran, Anthony Aristar and Helen Aristar-Dry. E-MELD and the School of Best Practices: An Ongoing Community Effort. In {\it Proceedings from Sustainable Data from Digital Fieldwork.} Sydney University Press. % 87--97
...
% Springer book series: "Theory and Applications of Natural  Language Processing",  (eds).

% Oxford Research Encyclopedia of Linguistics: Phonological inventories
...
\vskip 6pt
\hangpara{\bf 2017}\hspace{1ex}Moran, Steven and Robert Forkel. Python package \textit{segments} for tokenization and orthographic segmentation. \url{https://pypi.python.org/pypi/segments/}
...
\vskip 6pt
\hangpara{\bf 2014}\hspace{1ex}Vaux, Bert, Leemann, Adrian, Wanitsch, Daniel, Moran, Steven, Grimm, Sarah, Robert, Sylvain, Zhakarko, Taras and Scherrer, Yves. US Dialect App. Previously online via Apple App Store. % Online via Apple App Store: \url{http://usdialectapp.com/download}
...
\vskip 6pt
\hangpara
Moran, Steven. A Grammatical Sketch of Toro So [dts] and accompanying French -- English -- Toro So Dictionary. Work in progress which requires additional on-site fieldwork in Mali (planned 2018).

\begin{comment}
\vskip 6pt
\hangpara
Moran, Steven, Robert Schikowski, Danica Pajovi{\'c}, Cazim Hysi and Sabine Stoll. The ACQDIV Corpus: a comparative longitudinal language acquisition corpus. \url{http://www.acqdiv.uzh.ch/en/resources.html}
\end{comment}

\vskip 6pt
\hangpara
Schikowski, Robert, Steven Moran and Sabine Stoll. Manual for the ACQDIV corpus. Unpublished manuscript for ERC project: Acquisition processes in maximally diverse languages: min(d)ing the ambient language. Includes description of the ten longitudinal corpora, the extract transform load (ETL) processes for making the data interoperable, and the database design. 68pp. \url{http://www.acqdiv.uzh.ch/en/resources.html}
...
\end{flushleft}
\begin{itemize}
\item Basic statistics, Command line, Coldfusion, CSS, Git, HTML, Javascript, \LaTeX, Linked Data, Linux, MySQL, OS X, OWL, Photoshop, PHP, Python, R, RDF, SPARQL, SQL, Unix, XML
...
% 2018
% potentially: Reviewer Journal of Language Evolution; 
% Program committee: EXTENDED SEMANTIC WEB CONFERENCE (ESWC)
% LLOD 2018
% Organizer SLE 2018
...
\vskip 6pt
\hangpara
{\bf 2018}\hspace{1ex}\textit{Reviewer}: PLOS ONE; Conference on Computational Linguistics (COLING 2018). \textit{Workshop organizer}: `Comparative corpus linguistics: new perspectives and applications' at the 51st Annual Meeting of the Societas Linguistica Europaea (SLE), with Natalia Levshina and Annemarie Verkerk.
...
\item Schweizerischen Gesellschaft f{\"u}r bedrohte Sprachen (SGBS)
