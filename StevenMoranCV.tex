...
Rue Emile-Argand 11, G B35 & & \\
2000 Neuchâtel, Switzerland & & \\
& & \\
Online: & & \\
% \scriptsize\url{https://www.spur.uzh.ch/en/aboutus/Personen/staff/postdocs0/Steven-Moran.html} & & \\
...
\hangpara
{\bf Accepted.}\hspace{1ex}Moran, Steven, Nicholas A. Lester and Eitan Grossman. Inferring recent evolutionary changes in speech sounds. \textit{Philosophical Transactions of the Royal Society B: Biological Sciences}.

\hangpara
\vskip 6pt
{\bf Accepted.}\hspace{1ex}Urban, Matthias and Steven Moran. Altitude and the distributional typology of language structure: ejectives and beyond. \textit{PLoS ONE}.

% \hangpara
% {\bf In press.}\hspace{1ex}Levshina, Natalia and Steven Moran. Efficiency in human languages: corpus evidence for universal principles. In Natalia Levshina and Steven Moran (eds), \textit{Efficiency in human languages: corpus evidence for universal principles}. Linguistics Vanguard.
...
% Editorial board on LSP series Issues in Phonological Typology
...
\vskip 6pt
\hangpara
{\bf 2020}\hspace{1ex}\textit{Journal reviewer}: Diachronica; Frontiers Psychology; Linguistics Vanguard; Philosophical Transactions of the Royal Society B; Scientific Reports. \textit{Abstract reviewer}: 5th Usage-Based Linguistics conference. \textit{Scientific committee}: Evolution of Language International Conferences (EVOLANG 2020); 12th Language Resources and Evaluation (LREC 2020); 4th Computational Methods for Endangered Languages (ComputEL-4). \textit{Program committee}: 7th Workshop on Linked Data in Linguistics (LDL-2020); Conference on Computational Linguistics (COLING 2020).
