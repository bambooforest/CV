...
\vskip 6pt
\hangpara
{\bf 2019}\hspace{1ex}\textit{Scientific committee}: Language, Data, and Knowledge (LDK 2019). \textit{Reviewer}: Lingua; Open Handbook of Linguistic Data Management. \textit{Grant reviewer}: Endangered Language Documentation Programme (ELDP). \textit{Program committee}: Association Linguistic Typology (ALT 2019).
