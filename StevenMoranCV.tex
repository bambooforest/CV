...
% \hangpara
% {\bf Accepted.}\hspace{1ex}Danner, Tiena and Steven Moran. Female vocal tracts are optimized for speech. EVOLANG XVI.

% \vskip 6pt
% \hangpara
% {\bf Accepted.}\hspace{1ex}Ekström, Axel G., Claudio Tennie, Anna Jon-And and Steven Moran. Biocultural push-and-pull shapes phonemic repertoires. EVOLVING XVI.
