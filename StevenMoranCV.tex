...
& Committee: Verònica Grondona (Chair), Edward Garrett \\
...
\hangpara
{\bf Accepted}\hspace{1ex} Samardzic, Tanja, Ximena Gutierrez, Christian Bentz, Steven Moran and Olga Pelloni. A Measure for Transparent Comparison of Linguistic Diversity in Multilingual NLP Data Sets. NAACL Findings. Preprint: \url{https://arxiv.org/abs/2403.03909}. % June 16--21, Mexico City, Mexico.

\vskip 6pt
\hangpara
{\bf Accepted}\hspace{1ex}Chodroff, Eleanor, Blaž Pažon, Annie Baker and Steven Moran. Phonetic Segmentation of the UCLA Phonetics Lab Archive. The 2024 Joint International Conference on Compuational Linguistics and Language Resources and Evaluation (LREC-COLING 2024). % May 20-25, Turin, Italy.
...
\vskip 6pt
 \hangpara
{\bf 2022}\hspace{1ex}Moran, Steven, Christian Bentz, Ximena Gutierrez-Vasques, Olga Sozinova andTanja Samardzic. TeDDi Sample: Text Data Diversity Sample for Language Comparison and Multilingual NLP. In Proceedings of the 13th Conference on Language Resources and Evaluation (LREC 2022), 1150--1158. \url{http://www.lrec-conf.org/proceedings/lrec2022/pdf/2022.lrec-1.123.pdf}.
...
\hangpara Data Science of Language and Culture (APY 313). University of Miami, Spring 2023.
...
% Reviewer for Journal of Language Evolution
...
% \hangpara
% {\bf 2024}\hspace{1ex}Program committee, Association for Computational Linguistics (ACL 2024).
