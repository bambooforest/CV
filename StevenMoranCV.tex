...
% \vskip 6pt
\hangpara
{\bf In press.}\hspace{1ex}Ekström, Axel G., Charlotte Gannon, Jens Edlund, Steven Moran and Adriano R. Lameira. No missing link for chimpanzee speech production. \textit{Scientific Reports}. Prepint: \url{https://doi.org/10.31234/osf.io/359bd}.

\vskip 6pt
\hangpara
{\bf In press.}\hspace{1ex}Moran, Steven, Elad Eisen, Dmitry Nikolaev and Eitan Grossman. Operationalizing borrowability: phonological segments as a case study. \textit{Language}. Preprint: \url{https://www.researchgate.net/publication/380487963_Operationalizing_borrowability_phonological_segments_as_a_case_study}.
