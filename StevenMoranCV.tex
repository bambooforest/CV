...
\hangpara
\vskip 6pt
{\bf 2023}\hspace{1ex}Moran, Steven, Shelece Easterday and Eitan Grossman. Current research in phonological typology. \textit{Linguistic Typology}. \url{https://doi.org/10.1515/lingty-2022-0069}.
...
\end{flushleft}
 ...
 \hangpara
{\bf In press}\hspace{1ex}Ekstr{\"o}m, Axel G., Steven Moran, Johan Sundberg and Adriano R. Lameira. PREQUEL: Supervised phonetic approaches to analyses of great ape quasi-vowels. To appear in the proceedings of the International Congress of Phonetic Sciences (ICPhS 2023). Preprint online: \url{https://psyarxiv.com/8aeh4/}.

\vskip 6pt
\hangpara
{\bf In press}\hspace{1ex}Jiang, Zifan, Adrian Soldati, Isaac Schamberg, Adriano R. Lameira and Steven Moran. Automatic Sound Event Detection and Classification of Great Ape Calls Using Neural Networks. To appear in the proceedings of the International Congress of Phonetic Sciences (ICPhS 2023). Preprint online: \url{https://arxiv.org/abs/2301.02214}.
...
Levshina, Natalia and Steven Moran (eds). Efficiency in human languages: corpus evidence for universal principles. {\it Linguistics Vanguard}, 7, 3. \url{https://www.degruyter.com/journal/key/LINGVAN/7/s3/html}.
...
% Evolving spoken language: How cooking changed the cook
...
\vskip 6pt
\hangpara Data Science (2LN2319). University of Neuchâtel, Fall 2022, Spring 2022.
...
\end{flushleft}
\hangpara Integrative Models in Cognitive Science (2LN2210). University of Neuchâtel, annually Fall 2020--2022.
