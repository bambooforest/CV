...
\hangpara
{\bf 2019}\hspace{1ex}Moran, Steven$^*$, Dami{\'a}n E. Blasi$^*$, Scott R. Moisik, Paul Widmer, Dan Dediu and Balthasar Bickel. Human sound systems are shaped by post-Neolithic changes in bite configuration. \textit{Science}. DOI: \url{http://dx.doi.org/10.1126/science.aav3218}. $^*$Shared first authorship.
...
\vskip 6pt
\hangpara
{\bf 2019}\hspace{1ex}\textit{Scientific committee}: Language, Data, and Knowledge (LDK 2019). \textit{Reviewer}: Lingua. \textit{Grant reviewer}: Endangered Language Documentation Programme (ELDP). 
