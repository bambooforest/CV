...
\end{flushleft}
 ...
 \hangpara
{\bf In press.}\hspace{1ex}Moran, Steven, Christian Bentz, Ximena Gutierrez-Vasques, Olga Sozinova andTanja Samardzic. TeDDi Sample: Text Data Diversity Sample for Language Comparison and Multilingual NLP. In Proceedings of the Thirteenth International Conference on Language Resources and Evaluation (LREC 2022).
